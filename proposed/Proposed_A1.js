...
const ruleSet = stages.filter((stage) => stage.ruleSet === "Turf War");
console.log(ruleSet);

console.log("\n------------------\n");

// Array Type for find
const ruleSetDescription = stages.find((stage) => stage.ruleSet === "Turf War");
console.log(ruleSetDescription);
